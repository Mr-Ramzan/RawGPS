package com.otl.gps.navigation.map.route.view.activity.weather
...
import com.otl.gps.navigation.map.route.view.activity.weather.citiesWeather.CityAdapter
import com.otl.gps.navigation.map.route.view.activity.weather.citiesWeather.cityDetailInterface
import com.otl.gps.navigation.map.route.view.activity.weather.citiesWeather.cityWeather
import com.otl.gps.navigation.map.route.view.activity.weather.citiesWeather.cityWeatherViewModel
import com.otl.gps.navigation.map.route.view.activity.weather.currentWeather.CurrentWeather
import com.otl.gps.navigation.map.route.view.activity.weather.currentWeather.CurrentWeatherViewModel
import com.otl.gps.navigation.map.route.view.activity.weather.forecast.ForecastAdapter
import com.otl.gps.navigation.map.route.view.activity.weather.forecast.ForecastViewModel
import com.otl.gps.navigation.map.route.view.activity.weather.forecast.forecastWeather
import com.otl.gps.navigation.map.route.view.activity.weather.model.citiesModel
import com.otl.gps.navigation.map.route.view.activity.weather.utils.BackgroundManager
import com.otl.gps.navigation.map.route.view.activity.weather.utils.IconManager
