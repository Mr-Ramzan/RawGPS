...
class PreviewSavedPlacesActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    private lateinit var placeToPreview: SavedPlace
...
//        try {
        placeToPreview = Constants.savedPlace
...
//        loadBanner()
    ...
    private fun loadMap() {
        ...
        mapFragment?.getMapAsync(this@PreviewSavedPlacesActivity)
        getLocationFromPref()
    ...
    private fun checkPermissionBeforeLocation() {
        if (checkGPSStatus()) {
            Dexter.withContext(this@PreviewSavedPlacesActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (!report.areAllPermissionsGranted()) {
                            Toast.makeText(
                                this@PreviewSavedPlacesActivity,
    ...
    private fun checkGPSStatus(): Boolean {
        ...
        if (!::locationManager.isInitialized) {
            locationManager =
                this@PreviewSavedPlacesActivity.getSystemService(Context.LOCATION_SERVICE) as LocationManager
        }
        try {
        ...
        if (!gps_enabled && !network_enabled) {
            ...
            val dialog = AlertDialog.Builder(this@PreviewSavedPlacesActivity)
